...
exports.list_all_cards = function (req, res) {
  ...
  stripe.customers.listCards(user_id, param, function (err, cards) {
  ...
  stripe.tokens.create(
    ...
    function (err, token) {
      ...
      if (err) {
        ...
        stripe.customers.createSource(userID, param, function (err, card) {
          // asynchronously called
          if (err) {
            console.log(err);
            res("REQUEST ERROR");
...
exports.update_a_card = function (req, res) {
  ...
  stripe.customers.updateCard(userID, cardID, param, function (err, card) {
    // asynchronously called
    if (err) {
      console.log(err);
      res("REQUEST ERROR");
...
exports.delete_a_card = function (req, res) {
  ...
  stripe.customers.deleteCard(userID, cardID, function (err, confirmation) {
    // asynchronously called
    if (err) {
      console.log(err);
      res("REQUEST ERROR");
